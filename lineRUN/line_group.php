...
$accToken = "p9rGT1lUEF3ZBqjor3EbiWrbToa6aBoobBk3B6hGbDr";
$notifyURL = "https://notify-api.line.me/api/notify";

    $image_thumbnail_url = 'https://sv1.picz.in.th/images/2019/02/13/TAgrEb.th.jpg';  // max size 240x240px JPEG
    $image_fullsize_url = 'https://sv1.picz.in.th/images/2019/02/13/TAgrEb.jpg'; //max size 1024x1024px JPEG
...
$data = array(
    'message' => 'พนักงานเปิดเซฟทุกท่าน เชิญหยิบกุญแจเดี๋ยวนี้ วิ่งเร็วเข้าสิ เมี้ยว!!',
	'stickerPackageId' => 2,
    'stickerId' => 522,
